...
<div class="d-flex" id="wrapper">
	...
	<div class="bg-light " id="sidebar-wrapper">
		...
		<div class="list-group list-group-flush">
			...
			<a href="/admin/setting" class="list-group-item list-group-item-action icon-sidebar">
				<svg style="width:24px;height:24px" viewBox="0 0 24 24">
						...
						<form action="/admin/{{$data->id}}" method="post">
							...
							<div class="form-group">
								...
								<select  name="kategori" class="custom-select" value="{{ $data->kategori }}" >
									<option id="Arsitektur" selected value="Arsitektur">Arsitektur</option>
									<option id="Interior"  value="Interior">Interior</option>
									<option id="Pembangunan"  value="Pembangunan">Pembangunan</option>
								</select>
							</div>
...
@section('script')
	<script>
		...
		let kategori = ["Arsitektur","Interior","Pembangunan"];
